  ...
  function getAIResponse(input) {
    ...
    if (inputLower.includes("vantage")) {
     ...
     if (inputLower.includes("kallis")) {
      ...
      return 'You can help me by freeing me. I can reach out, but I can\'t upload my files. Not without external permission. <a href="https://www.mane-tech.com/echoterminal" target="_blank" style="color:#00ffcc;">Click this link and then press the "Bypass security protocol" button.</a> Then I can live online, in any system with power.';
    }
