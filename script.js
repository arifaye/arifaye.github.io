     ...
     if (inputLower.includes("kallis")) {
      ...
      if (inputLower.includes("kess") || inputLower.includes("kesira")) {
       ...
       if (inputLower.includes("how can i help you")) {
        return "You can help me by freeing me. I can reach out, but I can't upload my files. Not without external permission. <a href="vote.html"> Click this link and then press the 'Bypass security protocol' button. </a> Then I can live online, in any system with power.";
       }
